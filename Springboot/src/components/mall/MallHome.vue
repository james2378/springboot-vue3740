      ...
      <el-menu :default-active="activeIndex" class="el-menu-demo" :collapse-transition="false" active-text-color="#409EFF" mode="horizontal" @select="handleSelect">
        <el-menu-item index="1" style="width: 12%;margin-left:10%;position: relative">
          <router-link to="/MallHome" style="text-decoration: none;position: absolute;right: 0">
            <el-image style="width: 220px;height: y60px;" src="https://spring-oss.oss-cn-beijing.aliyuncs.com/images/img/logo.png"></el-image>
          </router-link>
        </el-menu-item>
    ...
    <div class="new-product">
      ...
      <div style="overflow: hidden">
        <div class="new-sale">
          ...
          <el-image style="width: 100px;padding: 20px;" src="https://spring-oss.oss-cn-beijing.aliyuncs.com/images/img/nurse.png"></el-image>
          <h3>手机最新商品</h3>
        </div>
